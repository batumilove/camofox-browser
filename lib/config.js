...
function loadConfig({ configPath = CONFIG_PATH } = {}) {
  ...
  return {
    ...
    tabAdmissionMaxActive: parseInt(process.env.TAB_ADMISSION_MAX_ACTIVE) || 4,
    tabAdmissionMaxActivePerUser: parseInt(process.env.TAB_ADMISSION_MAX_ACTIVE_PER_USER) || 2,
    tabAdmissionMaxAbandoned: parseInt(process.env.TAB_ADMISSION_MAX_ABANDONED) || 4,
    tabAdmissionMaxWaiting: parseInt(process.env.TAB_ADMISSION_MAX_WAITING) || 32,
    tabAdmissionMaxWaitingPerUser: parseInt(process.env.TAB_ADMISSION_MAX_WAITING_PER_USER) || 8,
    tabAdmissionWaitTimeoutMs: parseInt(process.env.TAB_ADMISSION_WAIT_TIMEOUT_MS) || 30000,
    tabAdmissionOperationTimeoutMs: parseInt(process.env.TAB_ADMISSION_OPERATION_TIMEOUT_MS) || newPageTimeoutMs,
    tabAdmissionRetryAfter: parseInt(process.env.TAB_ADMISSION_RETRY_AFTER) || 2,
    sessionDestroyingTimeoutMs: parseInt(process.env.SESSION_DESTROYING_TIMEOUT_MS) || 5000,
    ...
    serverEnv: {
      ...
      TAB_ADMISSION_MAX_ABANDONED: process.env.TAB_ADMISSION_MAX_ABANDONED,
      TAB_ADMISSION_MAX_WAITING: process.env.TAB_ADMISSION_MAX_WAITING,
      TAB_ADMISSION_MAX_WAITING_PER_USER: process.env.TAB_ADMISSION_MAX_WAITING_PER_USER,
      TAB_ADMISSION_WAIT_TIMEOUT_MS: process.env.TAB_ADMISSION_WAIT_TIMEOUT_MS,
      TAB_ADMISSION_OPERATION_TIMEOUT_MS: process.env.TAB_ADMISSION_OPERATION_TIMEOUT_MS,
      TAB_ADMISSION_RETRY_AFTER: process.env.TAB_ADMISSION_RETRY_AFTER,
      SESSION_DESTROYING_TIMEOUT_MS: process.env.SESSION_DESTROYING_TIMEOUT_MS,
