 ...
 * @param {Object} [opts]
 * @param {string[]} [opts.apis] - Glob patterns for files with @openapi JSDoc (default: server and persistence plugin routes)
 */
export function mountDocs(app, opts = {}) {
  const apis = opts.apis || ['./server.js', './plugins/persistence/index.js'];
